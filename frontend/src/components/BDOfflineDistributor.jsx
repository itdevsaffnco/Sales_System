...
export default function BDOfflineDistributor() {
    ...
    // Mock Data
    const metrics = {
        sales_value: 300000000,
        sales_qty: 2500,
        target_achievement: 92.5,
        growth_mom: 5.4,
        growth_yoy: 12.8,
        active_outlets: 150,
        registered_outlets: 200,
        new_outlets: 15,
    };

    const accountPerformance = [
        { account: 'Distributor A', sales: 85000000, target: 80000000, achievement: 106.25, growth: 8.5 },
        { account: 'Distributor B', sales: 65000000, target: 70000000, achievement: 92.8, growth: -2.1 },
        { account: 'Distributor C', sales: 50000000, target: 60000000, achievement: 83.3, growth: 1.5 },
        { account: 'Distributor D', sales: 45000000, target: 40000000, achievement: 112.5, growth: 15.2 },
        { account: 'Distributor E', sales: 35000000, target: 40000000, achievement: 87.5, growth: -5.0 },
    ];

    const growthTrend = [
        { month: 'Aug', sales: 220, target: 200 },
        { month: 'Sep', sales: 240, target: 210 },
        { month: 'Oct', sales: 230, target: 220 },
        { month: 'Nov', sales: 260, target: 240 },
        { month: 'Dec', sales: 290, target: 260 },
        { month: 'Jan', sales: 300, target: 280 },
    ]; // In Millions
        ...
        <div className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50">
            <div className="container mx-auto px-6 py-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800">Offline Distributor</h2>
                        <p className="text-sm text-gray-500 mt-1">Distributor network performance and coverage</p>
                    </div>
